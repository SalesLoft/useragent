...
describe "UserAgent: 'Mozilla/4.0 (compatible; MSIE 10.0; Windows Phone 8.0; Trident/3.1; IEMobile/10.0; SAMSUNG; SGH-i917)'" do
  before do
    @useragent = UserAgent.parse("Mozilla/4.0 (compatible; MSIE 10.0; Windows Phone 8.0; Trident/3.1; IEMobile/10.0; SAMSUNG; SGH-i917)")
  end
  ...
  it "should return 'Windows Phone OS 8.0' as its os" do
